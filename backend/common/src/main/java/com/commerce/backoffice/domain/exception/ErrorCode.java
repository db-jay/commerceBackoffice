...
public enum ErrorCode {
    ...
    DELIVERY_NOT_FOUND("DELIVERY_NOT_FOUND", "배송 정보를 찾을 수 없습니다."),
    DELIVERY_INVALID_STATUS_TRANSITION("DELIVERY_INVALID_STATUS_TRANSITION", "허용되지 않는 배송 상태 전이입니다."),
    DELIVERY_TRACKING_NUMBER_NOT_ALLOWED("DELIVERY_TRACKING_NUMBER_NOT_ALLOWED", "현재 상태에서는 송장 번호를 등록할 수 없습니다."),
    DELIVERY_TRACKING_NUMBER_REQUIRED("DELIVERY_TRACKING_NUMBER_REQUIRED", "송장 번호를 먼저 등록해야 합니다."),
